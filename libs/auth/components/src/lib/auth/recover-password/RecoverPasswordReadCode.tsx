...
export function RecoverPasswordReadCode({
  email,
  cancel,
  next,
}: RecoverPasswordReadCodeArgs) {
  ...
  const onFinish = (values: any) => {
    ...
    axios
      .post(
        `${process.env.VITE_SERVER_URL}/api/auth/valida-cod-seguridad`,
        data
      )
      .then((response) => {
    ...
    <div className={styles['login-form']}>
      ...
      >
        ...
        {error ? (
          ...
          <>
            <p>
              Ingrese el código de seguridad que hemos enviado al correo {email}
              :
            </p>

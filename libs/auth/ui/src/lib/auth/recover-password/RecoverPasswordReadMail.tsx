...
import { RecoverPasswordRequest } from '@starter-ws/auth/api';
...
export function RecoverPasswordReadMail({
  cancel,
  next,
  ...
  const onFinish = (values: any) => {
    ...
    axios
      .post(`${process.env.VITE_SERVER_URL}/api/auth/recover-pass`, data)
      .then(() => {
        next(email);
